...
<figure style="float: right; max-width: 500px;">
    <img style="margin: 15px;" src="/assets/images/submodels1.webp" alt="depiction of the two submodels">
    <figcaption style="font-style: italic; margin: 15px;"> Visualization of the two submodels, with a true underlying nest history generated by the nest creation submodel, and an observation history generated by the observer submodel.</figcaption>
</figure>
...
2. The observer submodel.
    ...
    Ability to correctly classify nest fate decreases over time following a simple exponential decay function. 
...
<figure style="width: 400px;">
    <img style="margin: 15px;" src="/assets/images/init_dates.webp" alt="sampled nest initiation dates for 100 runs of model compared to true initiation dates. the sampled distibutrions follow the true distribution.">
    <figcaption style="font-style: italic; margin: 15px;"> Sampled nest initiation dates for 100 runs of model (pink) compared to true initiation dates (blue).</figcaption>
</figure>
